...
@interface SareViewController ()

@end

@implementation SareViewController
...
{
    LookViewController *plistAddViewController = [[LookViewController alloc] init];
